...
const Livingroom = (props) => {
    ...
    return ( 
        <>
            ...
            <div className="roomTitle" onClick={()=>setModalShow(true)}><b className='roomText'>{props.title.replace(props.title[0], props.title[0].toUpperCase())}</b><br/><p className='roomValues'>Mode: {radios[LED.mode].name} </p></div>
            <Modal
                show={modalShow}
                size="lg"
                ...
                <br />
                <Button variant='danger' onClick={sendReq} style={{width: "20rem", height:"5rem",marginTop:"45px"}}>APPLY</Button>
                </Modal.Body>
                <Modal.Footer>
