...
const Bedroom = (props) => {
    ...
    return ( 
        <>
            ...
            <div className="roomTitle" onClick={()=>setModalShow(true)}><b className='roomText'>{props.title.replace(props.title[0], props.title[0].toUpperCase())}</b><br/><p className='roomValues'>Brightness: {LED.brightness}</p></div>
            <Modal
                show={modalShow}
                size="lg"
